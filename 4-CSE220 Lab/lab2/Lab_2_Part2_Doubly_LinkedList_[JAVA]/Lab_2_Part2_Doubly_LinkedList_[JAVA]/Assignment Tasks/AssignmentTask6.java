public class AssignmentTask6 {
    ...
    public static void pairJoin(DNode dh1, DNode dh2) {
        ...
        // Input lists are NOT circular — they terminate at null, not back at dh1
        while (p1 != null) {

            DNode next_p1 = p1.next;
            DNode next_p2 = p2.next;
        ...
        // The OUTPUT becomes circular — this part of your code was already correct
        tail.next = dh1;
        dh1.prev = tail;
    }
