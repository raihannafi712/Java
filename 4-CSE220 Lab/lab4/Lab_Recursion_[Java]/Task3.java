...
public class Task3 {
    ...
    public static int task3F_recursive(Node head) {
        ...
        return task3_helper_Odd(head) - task3_helper_Even(head);
    }

    private static int task3_helper_Even(Node head){
        ...
        if (temp.elem % 2 == 0) {
            ...
            return temp.elem * task3_helper_Even(temp.next);
        }
        return task3_helper_Even(temp.next);

    }

    private static int task3_helper_Odd(Node head){
        ...
        if (temp.elem % 2 != 0) {
            ...
            return temp.elem + task3_helper_Odd(temp.next);
        }
        return task3_helper_Odd(temp.next);
